<?php
	...
	list($year, $month, $day) = explode('-', $news_info['date']);
...
<div id="wrapper">
   ...
   <div id="main" class="inner">
      ...
      <div class="right">
      	...
      	<h1>Admin: Edit Latest News</h1>
         
         <p>Use the form below to edit the news.</p>
         
         <?php if($alerts->hasAlerts()) echo $alerts; ?>
         
			<form action="<?php echo getSelf(); ?>?nid=<?php echo $news_id; ?>" method="post">
...
?>
               ...
               <p><label for="news"><span class="required">*</span> News</label> <textarea name="news" id="news" class="wysiwyg"><?php echo $news_info['news']; ?></textarea></p>
               <p class="submit"><input type="submit" name="submit" id="submit" value="Edit News" /></p>
         </form> 
