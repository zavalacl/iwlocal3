	...
	if(isset($_POST['submit'])){
		try {
			...
			if(!$errors){
				...
				if(editWorkDescriptionCategory($category_id, $clean['category'])){
...
<div id="wrapper">
   ...
   <div id="main" class="inner">
      ...
      <div class="right">
        ...
        <p>Use the form below to update the work description category for Steward's Reports.</p>
         
				<form action="<?php echo getSelf(); ?>?cid=<?php echo $category_id; ?>" method="post" enctype="multipart/form-data">
         	<p><label for="category"><span class="required">*</span> Category</label> <input type="text" name="category" id="category" value="<?php echo htmlentities($category_info['category'], ENT_QUOTES); ?>" maxlength="255" /></p>
