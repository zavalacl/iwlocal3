	...
	if(isset($_POST['submit'])){
		try {
			...
			if(!$errors){
				...
				$result = newNews($clean['news'], $date);
				if($result > 0){
					header("Location: news_views.php?nn");
					exit;
				} else {
   ...
   <div id="main" class="inner">
      ...
      <div class="right">
      	<ul id="breadcrumbs">
         	...
         	<li>Add News &amp; Views</li>
         </ul>
               
      	<h1>Admin: Add News &amp; Views</h1>
         
         <p>Complete the form below to create a news &amp; views post.</p>
...
?>
               ...
               <p class="submit"><input type="submit" name="submit" id="submit" value="Add News &amp; Views" /></p>
         </form> 
