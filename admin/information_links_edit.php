<?php
	...
	$link_info = getInformationLink($link_id);
	...
	if(isset($_POST['submit'])){
		try {
			...
			if(!$errors){
				...
				if(editInformationLink($link_id, $clean['title'])){
...
<div id="wrapper">
   ...
   <div id="main" class="inner">
      ...
      <div class="right">
      	...
      	<h1>Admin: Announcements: Information Links: Edit Link</h1>
         
         <p>Complete the form below to edit a link in Information Links.</p>
         
         <?php if($alerts->hasAlerts()) echo $alerts; ?>
         
			<form action="<?php echo getSelf(); ?>?lid=<?php echo $link_id; ?>" method="post" enctype="multipart/form-data">
         	<p><label for="title"><span class="required">*</span> Title</label> <input type="text" name="title" id="title" value="<?php echo $link_info['title']; ?>" maxlength="255" /></p>
<?php
		if($isLink){
?>
            <p><label for="url"><span class="required">*</span> URL</label> <input type="text" name="url" id="url" value="<?php echo $link_info['url']; ?>" maxlength="255" /></p>
<?php
		} else {
?>
