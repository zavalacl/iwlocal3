<?php
	...
	// Delete a Contractor Category
	if(isset($_GET['d1'])){
		$did = escapeData($_GET['d1']);
		
		if(deleteContractorCategory($did) > 0)
...
<div id="wrapper">
   ...
   <div id="main" class="inner">
      ...
      <div class="right">
      	...
      	<a href="contractors_categories_add.php" class="icon_add">Add Contractor Category</a>
      	
      	<h1>Admin: Contractor Categories</h1>
...
?>
               <tr style="background-color:<?php echo $bkgd; ?>;">
                  <td width="90%"><?php echo $category['category']; ?></td>
                  <td width="10%">
                     <a href="contractors_categories_edit.php?cid=<?php echo $category['category_id']; ?>" class="icon_edit">Edit</a>
                     <a href="javascript:confirm_deletion(1,<?php echo $category['category_id']; ?>,'<?php echo getSelf(); ?>','category',0);" class="icon_delete">Delete</a>
                  </td>
               </tr>
<?php
			}
...
?>
               <tr>
                  <td colspan="4">There are currently no contractor categories.</td>
               </tr>
<?php
		}
?>
