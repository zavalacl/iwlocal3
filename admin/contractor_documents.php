<?php
	...
	if(isset($_GET['d1'])){
		...
		if(deleteContractorDocument($did) > 0)
...
<div id="wrapper">
   ...
   <div id="main" class="inner">
      ...
      <div class="right">
      	...
      	<a href="contractor_documents_add.php" class="icon_add">Add Document</a>
         
      	<h1>Admin: Contractor Documents</h1>
...
?>
            <tr style="background-color:<?php echo $bkgd; ?>;">
               ...
               <td>
                  <a href="contractor_documents_edit.php?did=<?php echo $document['document_id']; ?>" class="icon_edit">Edit</a>
