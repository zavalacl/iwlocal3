		...
		try {
			...
			if(!$errors){
				...
				if(move_uploaded_file($_FILES['file']['tmp_name'], $file_paths['contractor_documents'].$filename)){
					if(newContractorDocument($clean['title'], $filename, escapeData($_FILES['file']['name']), $clean['description']) > 0){
						header("Location: contractor_documents.php?nd");
						exit;
					} else {
...
<div id="wrapper">
   ...
   <div id="main" class="inner">
      ...
      <div class="right">
      	...
      	<h1>Admin: Add Contractor Document</h1>
