					...
					if($link_id > 0){
						...
						if($isLink){
							...
							if(editLinkURL($link_id, formatURI($clean['url']))){
								header("Location: other_links.php?nl");
								exit;
							} else {
...
<div id="wrapper">
   ...
   <div id="main" class="inner">
      ...
      <div class="right">
      	...
      	<h1>Admin: Announcements: Other Links: Add Link</h1>
         
         <p>Complete the form below to add a link. You must either select a file to upload or add a URL.</p>
