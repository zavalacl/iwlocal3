...
<div id="wrapper">
   ...
   <div id="main" class="inner">
      ...
      <div class="right">
      	...
      	<a href="news_views_add.php" class="icon_add">Add News &amp; Views</a>
         
      	<h1>Admin: News &amp; Views</h1>
...
?>
            <div class="item">
            	<div class="news">               
                  ...
                  <p><?php echo (strlen($item['news']) > 300) ? substr($item['news'], 0, 300).'...' : $item['news']; ?></p>
               </div>
               <ul class="options">
               	<li><a href="news_views_edit.php?nid=<?php echo $item['news_id']; ?>">Edit</a></li>
...
?>
				<p>There are currently no news &amp; views entries.</p>
<?php
		}
?>
         </div><!-- div#news --> 
