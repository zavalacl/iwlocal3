...
<div id="wrapper">
   ...
   <div id="main" class="inner">
      ...
      <div class="right">
      	<a href="employers_add.php" class="icon_add">Add an Employer</a><br />
      	<a href="employers_upload.php" class="icon_add">Update Paid-Through date via CSV file upload</a>
         
      	<h1>Benefits Department: Employers</h1>
...
?>
            <tr class="<?php echo $class; ?>">
              ...
              <td>
             		<a href="employers_edit.php?eid=<?php echo $employer['employer_id']; ?>" class="icon_edit">Edit</a>
