   ...
   <div id="main" class="inner">
      ...
      <div class="right">
      	...
      	<ul class="icon_options">
         	<li><a href="/download.php?id=<?php echo $report_id; ?>&amp;t=stewards_reports&amp;v2"><img src="/img/icon_pdf.gif" alt="PDF" /> Download PDF</a></li>
         </ul>
         ...
         <div class="row">
            ...
            <div class="block">
               ...
               <?php echo ($report_info['journeymen_wages_paid']) ? $report_info['journeymen_wages_paid'].'%' : ''; ?>
            </div>
         </div><!-- .row -->
         <div class="row">
            <div class="block">
...
?>
         ...
         <div class="row">
            ...
            <div class="block quarter">
               ...
               <?php echo $report_info['steward_email']; ?>
            </div>
         </div><!-- div.row -->
